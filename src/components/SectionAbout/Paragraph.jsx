  ...
  return (
    <div>
      <p className="lg:text-lg font-medium text-center lg:text-start">
        ...
        through Figma, which allows me to combine creativity with
        problem-solving and bring ideas to life through intuitive designs.
      </p>
      ...
      <p className="lg:text-lg font-medium text-center lg:text-start">
        ...
        content creation, audience engagement, and digital media.
      </p>
      ...
      <p className="lg:text-lg font-medium text-center lg:text-start">
        ...
        exposure to open-source development, teamwork, and real-world project
        collaboration, while continuously encouraging me to grow both
